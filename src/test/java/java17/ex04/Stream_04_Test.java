...
public class Stream_04_Test {
    ...
    public void test_of() throws Exception {
        ...
        Stream<String> result = new ArrayList<>(Arrays.asList("Alexandra", "Cyril", "Johnny", "Marion", "Sophie")).stream();
    ...
    public void test_iterate() throws Exception {
        ...
        Stream<Integer> result1 = Stream
                .iterate(1, (nbr)->nbr)
                .limit(5);
        Stream<Integer> result2 = Stream
                .iterate(1, (nbr)->nbr+1)
                .limit(5);
